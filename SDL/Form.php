        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fileInputs.forEach(input => {
                input.addEventListener('change', function() {
                    ...
                    const acceptedFormats = this.getAttribute('accept').split(',');
                    ...
                    if (this.files.length > 0) {
                        ...
                        // Check file size
                        if (fileSize > maxSize) {
                            alert(`File size exceeds the maximum limit of 20MB. Please select a smaller file.`);
                        ...
                        if (!acceptedFormats.includes(fileExt)) {
                            alert(`Invalid file format. Please upload only PDF, JPEG, or PNG files.`);
                            this.value = ''; // Clear the input
                        }
                    }
                });
