...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $requiredFields = [
        'surname', 'firstName', 'dateOfBirthDay', 'dateOfBirthMonth', 
        'dateOfBirthYear', 'sex', 'nationality', 'email', 
        'homeAddress', 'lrn', 'gradeLevel', 'fatherName', 'fatherContact', 
        'motherName', 'motherContact', 'guardianName', 'relationship', 
        'guardianContact'
    ];
    
    // Add strand to required fields if Grade 11 or 12 is selected
    if ($_POST['gradeLevel'] == '11' || $_POST['gradeLevel'] == '12') {
        $requiredFields[] = 'strand';
    }
...
<body>
    ...
    <div class="modal" id="privacyModal">
        <div class="modal-content">
            ...
            <button onclick="closePrivacyModal()" class="btn btn-primary">Okay</button>
        </div>
    </div>
    ...
    <script>
        ...
        function validatePersonalInfo() {
            ...
            for (let field of requiredFields) {
                ...
                } else if (field === 'dateOfBirthDay' || field === 'dateOfBirthMonth' || field === 'dateOfBirthYear') {
                    // Handle date fields which are selects with no ID
