...
<body>
    ...
    <!-- Personal Information Verified Modal -->
    <div class="modal" id="personalInfoModal" style="display: none;">
        <div class="modal-content">
            <span class="close-btn" onclick="closePersonalInfoModal()">&times;</span>
            <div class="modal-icon info-icon"></div>
            <h5>Personal Information Verified</h5>
            <button onclick="closePersonalInfoModal()" class="btn btn-primary">Continue</button>
        </div>
    </div>
    ...
    <div class="modal" id="successModal" style="display: none;">
        <div class="modal-content">
            ...
            <h5>Congratulations! You've Successfully Fill Out your Personal Information. You may now proceed to Login.</h5>
            <button onclick="closeSuccessModal()" class="btn btn-primary">Log In</button>
        </div>
    </div>
                ...
                <div class="card" id="personal-section">
                    <div class="card-body p-0">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="mt-4">
                            <button type="button" class="btn btn-primary" onclick="showPersonalInfoModal()">Next</button>
                        </div>
                    </div>
                </div>
                
                <!-- Guardian Information -->
                <div class="card" id="guardian-section" style="display: none;">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label for="fatherName" class="form-label">Father's Full Name <span class="required">*</span></label>
                            ...
                            <div class="col-md-4">
                                <label for="fatherContact" class="form-label">Father's Contact Number <span class="required">*</span></label>
                                <input type="text" class="form-control" id="fatherContact" name="fatherContact" required>
                            </div>
                            
                            <div class="col-md-4">
                                <label for="motherName" class="form-label">Mother's Full Name <span class="required">*</span></label>
                            ...
                            <div class="col-md-4">
                                <label for="motherContact" class="form-label">Mother's Contact Number <span class="required">*</span></label>
                                <input type="text" class="form-control" id="motherContact" name="motherContact" required>
                            </div>
                            
                            <div class="col-md-4">
                                <label for="guardianName" class="form-label">Guardian's Full Name <span class="required">*</span></label>
                                <input type="text" class="form-control" id="guardianName" name="guardianName" required>
                            </div>
                            <div class="col-md-4">
                                <label for="relationship" class="form-label">Relationship to Student <span class="required">*</span></label>
                                <input type="text" class="form-control" id="relationship" name="relationship" required>
                            </div>
                            <div class="col-md-4">
                                <label for="guardianContact" class="form-label">Guardian's Contact Number <span class="required">*</span></label>
                                <input type="text" class="form-control" id="guardianContact" name="guardianContact" required>
                            </div>
                        </div>
                        
                        <div class="mt-4 d-flex justify-content-between">
                            <button type="button" class="btn btn-secondary" onclick="prevStep('guardian', 'personal')">Previous</button>
    ...
    <script>
        ...
        function showPersonalInfoModal() {
            ...
            let personalInfoValid = validatePersonalInfo();
        ...
        function closePersonalInfoModal() {
            ...
            nextStep('personal', 'guardian');
        }
        
        function validatePersonalInfo() {
            // Get required fields
            const requiredFields = [
                'surname', 'firstName', 'sex', 'nationality', 'email', 
                'homeAddress', 'lrn', 'gradeLevel'
            ];
            ...
            for (let field of requiredFields) {
                ...
                if (element) {
                    if (!element.value) {
                        isValid = false;
                        errorMessage += "- " + field.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase()) + "\n";
                    }
                }
            }
            
            // Check date of birth fields
            const dobDay = document.querySelector('select[name="dateOfBirthDay"]');
            const dobMonth = document.querySelector('select[name="dateOfBirthMonth"]');
            const dobYear = document.querySelector('select[name="dateOfBirthYear"]');
            ...
            // Check if strand is selected for Grade 11 or 12
            const gradeLevel = document.getElementById('gradeLevel').value;
            if ((gradeLevel === '11' || gradeLevel === '12') && !document.getElementById('strand').value) {
                isValid = false;
                errorMessage += "- Senior High School Strand\n";
            }
        ...
        function prevStep(currentSection, prevSection) {
            ...
            document.getElementById(prevSection + '-section').style.display = 'block';
